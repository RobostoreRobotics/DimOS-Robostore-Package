...
_camera = (
    autoconnect(
        RealSenseCamera.blueprint(
            ...
            base_frame_id="body",
            # body->camera_link mount, plane-calibrated 2026-06-11 against the
            # Mid-360 cloud (pitch +15.05 deg, yaw -7.93 deg, roll~0).
            base_transform=Transform(
                translation=Vector3(0.05674, 0.0175, 0.01598),
                rotation=Quaternion(-0.009057, 0.130657, -0.068558, 0.989013),
            ),
        ),
    )
