...
class PController:
    ...
    # 0.5, not 0.2: the G1 firmware has a turn-rate deadband (~0.4 rad/s) and
    # ignores smaller yaw commands, stalling initial_rotation as the P-term
    # decays (observed: turns at 0.55, stalls at <=0.35).
    _min_angular_velocity: float = 0.5
