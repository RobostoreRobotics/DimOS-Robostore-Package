...
DEFAULT_RPC_TIMEOUTS: MappingProxyType[str, float] = MappingProxyType(
    {
        ...
        "start": 1200.0,
        # on_system_modules ships module proxies whose deserialization can
        # trigger heavy imports on the receiving worker (see
        # get_forkserver_context in python_worker.py); give it the same
        # headroom as start.
        "on_system_modules": 1200.0,
    }
)
